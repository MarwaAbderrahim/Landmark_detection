...
from image_tools import resample_spacing
from landmark_utils import is_world_coordinate_valid, is_voxel_coordinate_valid
...
def gen_landmark_mask_batch(image_folder, landmark_folder, target_landmark_label,
  ...
  for image_name in image_names:
    ...
    target_landmark_df = {}
    print("landmark_df", landmark_df)
    print("target_landmark_label.keys()", target_landmark_label.keys())
    target_landmark_label = {key.strip(): value for key, value in target_landmark_label.items()}
    print("target_landmark_label.keys()", target_landmark_label.keys())
    for landmark_name in target_landmark_label.keys():
      landmark_name = landmark_name.strip()  # Remove any trailing or leading whitespace

      landmark_label = target_landmark_label[landmark_name]
      print("landmark_name", landmark_name)
      print("landmark_label", landmark_label)
...
def main():
  ...
  default_batch_idx = 1
  default_input = r'C:\Users\MarwaABDERRAHIM\OneDrive - ABYS MEDICAL\Bureau\IA\Landmarks\test_data\teeest'
  default_landmark = r'C:\Users\MarwaABDERRAHIM\OneDrive - ABYS MEDICAL\Bureau\IA\Landmarks\test_data\land'
  default_output = r'C:\Users\MarwaABDERRAHIM\OneDrive - ABYS MEDICAL\Bureau\IA\Landmarks\test_data\out/batch_{}_1.5mm'.format(default_batch_idx)
  default_label = r"C:\Users\MarwaABDERRAHIM\OneDrive - ABYS MEDICAL\Bureau\IA\Landmarks\test_data\landmark_label_file_batch_1.csv"
